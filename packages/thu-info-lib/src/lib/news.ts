...
const handleNewApiNews = async (url: string): Promise<[string, string, string]> => {
    ...
    const textContent = decode(data.object.xxDto.nr).replace(/src="\/b\/ckeditor\/downloadFiles/g, "src=\"/https/77726476706e69737468656265737421f9f9479369247b59700f81b9991b2631506205de/b/ckeditor/downloadFiles");
