...
export const NETWORK_IMPORT_IP =
    "https://webvpn.tsinghua.edu.cn/https/77726476706e69737468656265737421e5e4448e223726446d0187ab9040227b54b6c80fcd73/ip_login_import.php";
export const NETWORK_IMPORT_CHALLENGE =
  "https://webvpn.tsinghua.edu.cn/https/77726476706e69737468656265737421f1e25594737e7c4377068ea48d546d30da79d227b1/cgi-bin/get_challenge?callback=m&username={username}&ip={ip}";
export const NETWORK_IMPORT_LOGIN =
  "https://webvpn.tsinghua.edu.cn/https/77726476706e69737468656265737421f1e25594737e7c4377068ea48d546d30da79d227b1/cgi-bin/srun_portal?callback=m&action=login&username={username}&password=%7BMD5%7D{pass_md5}&ac_id={nas_id}&ip={ip}&info={info}&chksum={checksum}&n=200&type=1";
export const NETWORK_1X_USER =
