    ...
    connect(
        ...
        if (json.getString("success") == "false")
            ...
            mutableMapOf<String, String?>(
                "是否免测" to json.getString("sfmc"),
                "免测原因" to json.getString("mcyy"),
                "总分" to json.getString("zf"),
                "标准分" to json.getString("bzf"),
                "附加分" to json.getString("fjf"),
                "长跑附加分" to json.getString("cpfjf"),
                "身高" to json.getString("sg"),
                "体重" to json.getString("tz"),
                "身高体重分数" to json.getString("sgtzfs"),
                "肺活量" to json.getString("fhl"),
                "肺活量分数" to json.getString("fhltzfs"),
                "800M跑" to json.getString("bbmp"),
                "800M跑分数" to json.getString("bbmpfs"),
                "1000M跑" to json.getString("yqmp"),
                "1000M跑分数" to json.getString("yqmpfs"),
                "50M跑" to json.getString("wsmp"),
                "50M跑分数" to json.getString("wsmpfs"),
                "立定跳远" to json.getString("ldty"),
                "立定跳远分数" to json.getString("ldtyfs"),
                "坐位体前屈" to json.getString("zwtqq"),
                "坐位体前屈分数" to json.getString("zwtqqfs"),
                "仰卧起坐" to json.getString("ywqz"),
                "仰卧起坐分数" to json.getString("ywqzfs"),
                "引体向上" to json.getString("ytxs"),
                "引体向上分数" to json.getString("ytxsfs"),
                "体育课成绩" to json.getString("tykcj")
            )
        }
    }
}
