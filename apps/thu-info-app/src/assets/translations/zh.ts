export default {
	"scheduleImportTitle": "从 ICS 导入",
	"scheduleImportIntro": "导入电脑或日历工具整理的课程、周末安排。仅处理本地文件，不上传、不订阅。支持单日定时日程和按天/周重复；全天、跨午夜及不支持的规则会列出跳过原因。",
	"scheduleImportRangeHint": "默认日期来自当前显示学期，可修改；最多 366 天。按日程开始日期筛选，包含结束日期。不会修改 App 的学期设置。",
	"scheduleImportStart": "开始日期",
	"scheduleImportEnd": "结束日期（含当天）",
	"scheduleImportRangeError": "请输入有效的 YYYY-MM-DD 日期，结束日期不得早于开始日期，范围最多 366 天。",
	"scheduleImportAppend": "补充导入",
	"scheduleImportReplace": "覆盖日期范围",
	"scheduleImportAppendHint": "保留现有安排；完全重复的记录跳过，时间冲突仅提示。",
	"scheduleImportReplaceHint": "覆盖范围内的全部现有安排，不只是与新课表冲突的部分。范围外不变；该范围内的官方日程在刷新后仍保持屏蔽。",
	"scheduleImportReplaceWarning": "将移除所选日期范围内的 {0} 条现有安排，再写入所选的新日程。即使某天没有新日程，旧安排也会移除。被覆盖的本地安排不能自动恢复，请先导出备份。官方安排将持续屏蔽，直到您选择恢复。",
	"scheduleImportChoose": "选择 .ics 文件",
	"scheduleImportPreview": "重新生成预览",
	"scheduleImportLoading": "正在读取和解析",
	"scheduleImportReadError": "无法读取文件，请确认文件已下载到设备后重试。",
	"scheduleImportSummary": "已选 {0} 条；重复 {1} 条；跳过 {2} 项；覆盖影响 {3} 条。",
	"scheduleImportFloating": "文件包含无时区日程，按设备本地时区解释；请核对预览时间。",
	"scheduleImportConfirm": "确认导入",
	"scheduleImportConfirmCount": "即将导入 {0} 条日程。",
	"scheduleImportSkippedWarning": "有 {0} 项因范围或格式限制被跳过。请确认已检查跳过原因；覆盖模式不会保留这些项对应的旧安排。",
	"scheduleImportConflictHint": "时间冲突：将同时保留，不删除或隐藏其他安排。",
	"scheduleImportDone": "已导入 {0} 条日程。若当前课表未显示，请切换到对应学期/周，并开启本地日程或周末显示。",
	"scheduleImportOverrides": "以下日期范围已屏蔽官方日程：",
	"scheduleImportRestore": "恢复官方日程",
	"scheduleImportRestoreHint": "联网刷新成功后，解除全部导入覆盖范围的屏蔽。保留导入的本地日程（与官方日程完全重合的项按现有刷新规则去重）。这不会恢复被覆盖删除的本地安排。",
	"scheduleImportUnnamed": "未命名日程",
	"scheduleImportAffected": "覆盖模式将移除这条现有安排",
	"scheduleImportDuplicate": "完全重复，已跳过",
	"scheduleImportNothing": "没有可导入的新日程，现有课表未改变。",
	"scheduleImportInvalidEvent": "跳过：名称、日期或起止时间无效",
	"scheduleImportAllDay": "跳过：首版不支持全天事件",
	"scheduleImportOvernight": "跳过：首版不支持跨午夜事件",
	"scheduleImportTimezone": "跳过：文件中的时区没有可用定义",
	"scheduleImportRecurrence": "跳过：不支持的重复规则或改期格式",
	"scheduleImportCancelled": "跳过：已取消的日程",
	"scheduleImportOutside": "跳过：所选日期范围内没有日程",
	"scheduleImportInvalidFile": "请选择有效的 .ics 日历文件。",
	"scheduleImportFileTooLarge": "文件超过 5 MiB，请缩小导出范围。",
	"scheduleImportLimit": "文件或重复展开超出安全上限，本次未导入任何日程。请缩小文件或日期范围。",
	mark: "CH",
	infoAccount: "信息门户账号",
	myhomeAccount: "家园网账号",
	appSecret: "应用密码",
	...
	scheduleUploadCustomMessage: "是否将当前学期的自定义日程上传至网络学堂？\n注意：上传后不支持修改。",
