export default {
	...
	thosUnread: "待阅",
	thosPhases: "阶段性事项",
	thosConnectionError: "连接在线服务失败，请重试。",
	thosReading: "读取中",
	thosOpenWebsite: "进入在线服务网站",
	thosTaskLoadFailed: "{0}读取失败，请重试。",
	thosServiceDirectoryLoadFailed: "服务目录读取失败，请重试。",
	thosFavoritesSaveFailed: "收藏保存失败，请重试",
	thosDemoNotice: "演示账号 · 虚构数据，网页入口已禁用",
	thosLogin: "使用 THU Info 账号登录",
	thosFavorites: "收藏服务",
	thosAllServices: "全部服务",
	thosSearchAccessibility: "搜索在线服务",
	thosSearchFavorites: "搜索收藏服务",
	thosSearchServices: "搜索服务或部门，如入校、场地",
	thosSearchTasks: "搜索事务、编号或节点",
	thosPartialResults: "当前为部分结果。",
	thosCancelFavorite: "取消收藏",
	thosFavoriteService: "收藏服务",
	thosDepartmentUnavailable: "部门未提供",
	thosSummary: "事项摘要：",
	thosProgress: "进度 {0}%",
	thosCompletionTime: "办结时间",
	thosLastModifiedTime: "最后修改时间",
	thosApplicationTime: "申请时间",
	thosNoFavorites: "还没有收藏服务，去全部服务收藏常用事项。",
	thosNoMatch: "没有匹配结果",
	thosNoTasks: "当前没有此类事项",
	thosNoResults: "当前尚无结果。",
	thosRefreshTime: "刷新时间：",
	thosRefresh: "刷新",
	thosUnsupportedLink: "此链接类型暂不支持",
	thosExternalLink: "打开外部链接",
	thosExternalLinkMessage: "将在系统浏览器或其他应用中继续。",
	thosOpen: "打开",
	thosNoLinkApp: "没有可打开此链接的应用",
	thosSessionRefresh: "THOS 会话需要更新，请点右上角刷新，使用内置认证继续。",
	thosPortalLoading: "正在载入",
	thosSessionLoading: "正在复用 THU Info 登录会话…",
	thosPortalLoadFailed:
		"页面加载失败，请点右上角刷新。若正处理表单，请先在事务列表核对状态。",
	thosHttpError: "系统页面暂时不可用（HTTP {0}）",
	thosRenderProcessGone:
		"网页进程已退出，请点击右上角刷新。未提交的表单可能需要重新填写。",
	thosContentProcessGone: "网页进程已退出，请点击右上角刷新。",
	thosDetailUpdateFailed:
		"未能更新详情。当前显示上次读取的信息；事项状态可能已变化，请返回列表刷新核对。",
	thosAccountChanged: "登录账号已变化，请返回在线服务重新读取。",
	thosTaskDetail: "事务详情",
	thosCurrentNode: "当前办理节点",
	thosFlowProgress: "系统流程进度 {0}%",
	thosAccessibilityProgress: "流程进度 {0}%",
	thosWorkflowStatus: "办理状态",
	thosPhaseDetails: "阶段明细",
	thosUnknownStatus: "状态未知",
	thosRelatedServices: "其他相关服务",
	thosTaskNumber: "事务编号",
	thosServiceInfo: "服务信息",
	thosDepartment: "提供部门",
	thosServiceType: "服务类型",
	thosOpenStatus: "开放时间状态",
	thosInOpenPeriod: "在开放时间内",
	thosOutOfOpenPeriod: "不在开放时间内",
	thosHowToHandle: "办理方式",
	thosServiceGroupDescription:
		"这是服务集合，具体事项与办理条件请查看服务详情。",
	thosServiceDescription:
		"服务信息在 App 内查看。申请表单仍由网页提供，进入后请按学校说明办理。",
	thosFavoriteHint:
		"收藏常用服务后，可从「收藏服务」直接找到。收藏在目录中管理，仅保存在本机。",
	thosFormService: "填报服务",
	thosGuideService: "引导服务",
	thosIntegrationService: "集成服务",
	thosServiceGroup: "服务集合",
	thosStatusReturned: "退回修改",
	thosStatusTodo: "待我处理",
	thosStatusOngoing: "正在办理",
	thosStatusCompleted: "已办结",
	thosStatusSuccess: "办理成功",
	thosStatusFailed: "办理失败",
	thosStatusWithdrawn: "已撤回",
	thosStatusDraft: "草稿",
	thosStatusUnread: "未阅",
	thosStatusRead: "已阅",
	thosStatusHandledBy: "任务已被{0}办理",
	thosStatusPending: "待办理",
	mark: "CH",
	infoAccount: "信息门户账号",
	myhomeAccount: "家园网账号",
	appSecret: "应用密码",
	...
	periods: "节数",
	scheduleDate: "日期",
	scheduleTimeRange: "时间段",
	scheduleRepeatWeekly: "每周在同一天同时段重复",
	scheduleAddModeWeekPeriod: "按周数和节次添加",
	scheduleAddModeDateTime: "按日期和时间添加",
	scheduleInvalidTimeTitle: "时间无效",
	scheduleInvalidTimeMessage: "结束时间必须晚于开始时间，且在同一天内。",
	lunch: "午休",
	supper: "晚饭",
	dayOfWeek: ["周日", "周一", "周二", "周三", "周四", "周五", "周六", "周日"],
	scheduleOverlapWarning: "注意：部分日程有重叠。",
	delete: "删除",
	hide: "隐藏",
	all: "全部",
	topped: "置顶",
	...
	scheduleConflict: "日程冲突",
	customIntro: "您新建的日程与下列日程相冲突：\n\n",
	customText:
		"\n\n点击“确认”则会覆盖已有日程（如果自定义日程所有时间段均被覆盖，这个日程会被删除），点击“取消”放弃新建日程",
	unhideIntro: "您要恢复的日程与下列日程相冲突：\n\n",
	unhideText:
		"\n\n点击“确认”则会覆盖已有日程（如果自定义日程所有时间段均被覆盖，这个日程会被删除），点击“取消”放弃恢复日程",
	delSchedule: "删除",
	hideSchedule: "隐藏",
	hideScheduleText: "隐藏日程",
	hideScheduleConfirmationText: "您确定要隐藏此日程吗？此为重复日程。",
	allTime: "本学期所有时段该日程",
	repeatly: "本学期每周同时段该日程",
	once: "该时段日程",
	delLocation: "清除地点",
	...
	scheduleEditRepeatingMessage: "“仅本次”只修改所选这一次的名称、地点和时间；“所有重复”修改本学期同一时段的所有场次。",
	...
	syncReceiveInitialCaption:
		"即将从您的其他设备接收日程。\n请确保设备在同一网络环境内。",
	syncSendWaitOtherCaption: "正在等待其他设备接收日程...",
	syncReceiveWaitOtherCaption: "正在等待其他设备发送日程...",
	syncToConfirmCaption: "配对的令牌是 {0} ，请确保另一设备上显示相同的令牌。",
	syncWaitSyncCaption: "正在等待另一设备确认同步...",
	syncDoneCaption: "成功同步了日程。",
	syncReceiveWarning: "警告！接收的日程将覆盖您当前的日程。",
	start: "开始",
	sync: "同步",
	return: "返回",
	...
	washerStandby: "待机",
	washerUnknown: "状态未知",
	washerEstimatedEnd: "预计结束",
	washerRefreshFailed: "刷新失败，当前显示上次数据",
	washerRetry: "重试",
	washerRoom: "洗衣房",
	washerTypeWasher: "洗衣机",
	washerTypeDryer: "烘干机",
	washerTypeWasherDryer: "洗烘一体机",
	washerTypeShoeWasher: "洗鞋机",
	washerTypeOther: "其他设备",
	favourites: "收藏",
	washerIdle: "空闲",
	washerWorking: "运行中",
	minutesAbbr: "分钟",
	...
	deepseekScheduleCreated: "已为你创建日程",
	deepseekScheduleFail: "未能创建日程，请检查信息后重试",
	scheduleUploadCustomTitle: "上传自定义日程到网络学堂",
	scheduleUploadCustomMessage:
		"是否将当前学期的自定义日程上传至网络学堂？\n注意：上传后不支持修改。",
	scheduleUploadCustomConfirm: "上传",
	scheduleUploadCustomSuccess: "已将自定义日程上传至网络学堂",
};
