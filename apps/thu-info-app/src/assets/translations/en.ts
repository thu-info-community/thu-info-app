export default {
	...
	thosActive: "Active Tasks",
	thosTodo: "My Tasks",
	thosCompleted: "Completed",
	thosDrafts: "Drafts",
	thosUnread: "Unread",
	thosPhases: "Phased Tasks",
	thosConnectionError: "Failed to connect to Online Services. Please retry.",
	thosReading: "Reading",
	thosOpenWebsite: "Open Online Services website",
	thosTaskLoadFailed: "Failed to load {0}. Please retry.",
	thosServiceDirectoryLoadFailed: "Failed to load the service directory. Please retry.",
	thosFavoritesSaveFailed: "Failed to save favorites. Please retry.",
	thosDemoNotice: "Demo account · fictional data; web entry is disabled",
	thosLogin: "Log in with THU Info account",
	thosFavorites: "Favorite Services",
	thosAllServices: "All Services",
	thosSearchAccessibility: "Search Online Services",
	thosSearchFavorites: "Search favorite services in Chinese",
	thosSearchServices: "Search services or departments in Chinese",
	thosSearchTasks: "Search tasks, IDs, or nodes in Chinese",
	thosPartialResults: "Partial results are shown.",
	thosCancelFavorite: "Unfavorite service",
	thosFavoriteService: "Favorite service",
	thosDepartmentUnavailable: "Department unavailable",
	thosSummary: "Summary: ",
	thosProgress: "Progress {0}%",
	thosCompletionTime: "Completion time",
	thosLastModifiedTime: "Last modified",
	thosApplicationTime: "Application time",
	thosNoFavorites:
		"No favorite services yet. Add commonly used services from All Services.",
	thosNoMatch: "No matching results",
	thosNoTasks: "No tasks of this type",
	thosNoResults: "No results yet.",
	thosRefreshTime: "Refreshed at: ",
	thosRefresh: "Refresh",
	thosUnsupportedLink: "This link type is not supported",
	thosExternalLink: "Open external link",
	thosExternalLinkMessage: "Continue in the system browser or another app.",
	thosOpen: "Open",
	thosNoLinkApp: "No app can open this link",
	thosSessionRefresh:
		"The THOS session needs to be refreshed. Tap Refresh to continue with built-in authentication.",
	thosPortalLoading: "Loading",
	thosSessionLoading: "Reusing the THU Info login session…",
	thosPortalLoadFailed:
		"The page failed to load. Tap Refresh. If you are handling a form, check its status in the task list first.",
	thosHttpError: "The system page is temporarily unavailable (HTTP {0})",
	thosRenderProcessGone:
		"The web process exited. Tap Refresh. Any unsubmitted form may need to be filled out again.",
	thosContentProcessGone: "The web process exited. Tap Refresh.",
	thosDetailUpdateFailed:
		"Failed to update the details. The last read information is shown; the task status may have changed. Return to the list and refresh to verify.",
	thosAccountChanged:
		"The logged-in account changed. Return to Online Services and read the data again.",
	thosTaskDetail: "Task Details",
	thosCurrentNode: "Current Node",
	thosFlowProgress: "Process progress {0}%",
	thosAccessibilityProgress: "Process progress {0}%",
	thosWorkflowStatus: "Workflow Status",
	thosPhaseDetails: "Phase Details",
	thosUnknownStatus: "Unknown status",
	thosRelatedServices: "Related Services",
	thosTaskNumber: "Task ID",
	thosServiceInfo: "Service Information",
	thosDepartment: "Provider",
	thosServiceType: "Service Type",
	thosOpenStatus: "Availability",
	thosInOpenPeriod: "Currently available",
	thosOutOfOpenPeriod: "Currently unavailable",
	thosHowToHandle: "How to Use",
	thosServiceGroupDescription:
		"This is a service group. See individual service details for specific services and requirements.",
	thosServiceDescription:
		"Service information is available in the app. Application forms are provided on the web; follow the university instructions after opening them.",
	thosFavoriteHint:
		"Favorite commonly used services to find them from Favorite Services. Favorites are managed in the directory and stored only on this device.",
	thosFormService: "Form Service",
	thosGuideService: "Guide Service",
	thosIntegrationService: "Integrated Service",
	thosServiceGroup: "Service Group",
	thosStatusReturned: "Returned for revision",
	thosStatusTodo: "Action required",
	thosStatusOngoing: "In progress",
	thosStatusCompleted: "Completed",
	thosStatusSuccess: "Completed successfully",
	thosStatusFailed: "Failed",
	thosStatusWithdrawn: "Withdrawn",
	thosStatusDraft: "Draft",
	thosStatusUnread: "Unread",
	thosStatusRead: "Read",
	thosStatusHandledBy: "Handled by {0}",
	thosStatusPending: "Pending",
	mark: "EN",
	...
	passwordUsedWhen: "Verify password when:",
	custom: "Custom",
	lockTime: "Lock after",
	instantly: "Instantly",
	minute: "minute",
	...
	confirmReportUnknownSocket:
		"You are going to report this seat as unknown status.",
	socketReportShort: "Hold down to report socket status",
	...
	gpaTooltip:
		"GPA is for reference only. Please check the official transcript for the finalized result.",
	...
	peekScore: "Course Grade",
	enterCourseId: "Enter course number",
	...
	scheduleICSDownloaded:
		"Schedule calendar has been saved to your Downloads folder",
	scheduleICSFileName: "CourseSchedule",
	scheduleCourseTypePrimary: "Primary Course",
	scheduleCourseTypeSecondary: "Secondary Course",
	scheduleCourseTypeExam: "Exam",
	scheduleCourseTypeCustom: "Custom",
	scheduleFilterOfficial: "Synced schedules",
	scheduleFilterCustom: "Local schedules",
	scheduleICSDescription: "Course Type",
	scheduleICSTimeSlot: "Time",
	scheduleICSPeriod: "{0}-{1}",
	scheduleICSWeekPrefix: "Week ",
	scheduleICSWeekSuffix: "",
	scheduleCourseTypeUnknown: "Unknown",
	...
	periods: "Periods",
	scheduleDate: "Date",
	scheduleTimeRange: "Time range",
	scheduleRepeatWeekly: "Repeat weekly on this day",
	scheduleAddModeWeekPeriod: "By weeks & periods",
	scheduleAddModeDateTime: "By date & time",
	scheduleInvalidTimeTitle: "Invalid time range",
	scheduleInvalidTimeMessage:
	...
	allTime: "the schedule (all occurrences this semester)",
	repeatly: "the schedule (matching occurrences this semester)",
	...
	scheduleEditRepeatingMessage:
		"Change once updates the title, location and time of this occurrence only. All repeating updates matching occurrences in this semester.",
	...
	choose: "Select",
	questionMark: "?",
	noInvoice: "You have no fapiao now.",
	...
	networkContactEmail: "Email",
	networkAccountStatus: "Status",
	networkUserGroup: "User Group",
	networkAllowedDevices: "Max Devices",
	networkProductName: "Product Name",
	networkRemainder: "Remainder",
	networkSettlementDate: "Settlement Date",
	networkUsedBytes: "Used Bytes",
	networkUsedTime: "Used Time",
	...
	jieli: "Jieli Smart",
	xiaolanSmart: "Xiaolan Smart",
	washerOffline: "Offline",
	washerStandby: "Standby",
	washerUnknown: "Unknown",
	washerEstimatedEnd: "Estimated end",
	washerRefreshFailed: "Refresh failed; showing previous data",
	washerRetry: "Retry",
	washerRoom: "Laundry room",
	washerTypeWasher: "Washer",
	washerTypeDryer: "Dryer",
	washerTypeWasherDryer: "Washer-dryer",
	washerTypeShoeWasher: "Shoe washer",
	washerTypeOther: "Other device",
	...
	scheduleUploadCustomMessage:
		"Upload custom schedules of current semester to 网络学堂?\nSchedules are not editable once uploaded.",
